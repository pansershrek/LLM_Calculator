...
def main():
    ...
    parser.add_argument(
        "--dataset_path", default="dataset/bloom-3b-add-dataset.json", help="Path to dataset"
    )
    ...
    if args.base_model != bigscience/bloom-3b:
        TARGET_MODULES = [
            "q_proj",
            "v_proj",
            "k_proj",
    ...
    model.save_pretrained(args.lora_weights)
